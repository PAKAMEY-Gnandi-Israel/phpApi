	...
	class Rest {
		...
		public function validateParameter($fieldName, $value, $dataType, $required = true) {
			...
			switch ($dataType) {
				...
				case STRING:
					...
					case DOUBLE:
					if(!is_double($value)) {
						$this->throwError(VALIDATE_PARAMETER_DATATYPE, "Datatype is not valid for " . $fieldName . '. It should be double.');
					}
					break;
				default:
		...
		public function validateToken() {
			try {
				...
				$stmt = $this->con->prepare("SELECT * FROM administrateur WHERE id = :userId");
